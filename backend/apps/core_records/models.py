...
class QuironRecord(models.Model):
    ...
    def __str__(self):
        return (
            f'{self.type_product_name}: {self.product_name}'
            f' - {self.speciality_name} - {self.center} - {self.province_name}'
        )
...
class SaludonnetRecord(models.Model):
    ...
    def __str__(self):
        return f'{self.product_name} - {self.speciality_name} - {self.center} - {self.province_name}'
...
class IglobalmedRecord(models.Model):
    ...
    def __str__(self):
        return f'{self.product_name} - {self.speciality_name} - {self.center} - {self.city}'
