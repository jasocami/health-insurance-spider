...
from apps.generic.csv_tools import ClinicPointRecordsCSVDownloadView, QuironRecordsCSVDownloadView, \
...
from apps.core_records.models import QuironRecord, SaludonnetRecord, ClinicPointRecord, SmartSalusRecord, \
...
class QuironRecordAdmin(admin.ModelAdmin):
    ...
    quiron_export_all_csv.short_description = 'Export all to CSV'
...
class SaludonnetRecordAdmin(admin.ModelAdmin):
    ...
    saludonnet_export_all_csv.short_description = 'Export all to CSV'
...
class ClinicPointRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product_name', 'speciality_name', 'center')
    readonly_fields = ['creation_timestamp', 'last_update_timestamp']
    clinicpoint_export_all_csv.short_description = 'Export all to CSV'
...
class SmartSalusRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product_name', 'speciality_name', 'center')
    readonly_fields = ['creation_timestamp', 'last_update_timestamp']
    smart_salus_export_all_csv.short_description = 'Export all to CSV'
...
class IglobalmedRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product_name', 'speciality_name', 'center')
    readonly_fields = ['creation_timestamp', 'last_update_timestamp']
    iglobalmed_export_all_csv.short_description = 'Export all to CSV'
...
class OperarmeRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product_name', 'speciality_name', 'center')
    readonly_fields = ['creation_timestamp', 'last_update_timestamp']
    operarme_export_all_csv.short_description = 'Export all to CSV'
...
class MiDiagnosticoRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product_name', 'speciality_name', 'center')
    readonly_fields = ['creation_timestamp', 'last_update_timestamp']
    midiagnostico_export_all_csv.short_description = 'Export all to CSV'
...
class BonomedicoRecordRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product_name', 'speciality_name', 'center')
    readonly_fields = ['creation_timestamp', 'last_update_timestamp']
    bonomedico_export_all_csv.short_description = 'Export all to CSV'
...
class PortalsaludSanitasRecordRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product_name', 'speciality_name', 'center')
    readonly_fields = ['creation_timestamp', 'last_update_timestamp']
    portalsalud_sanitas_export_all_csv.short_description = 'Export all to CSV'
