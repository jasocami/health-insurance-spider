...
from apps.core_records.models import SmartSalusRecord as Record
...
class SmartSalusScrape(BaseScrape):
    ...
    def parse(self, response, **kwargs):
        ...
        for option in provinces_options:
            ...
            print(f'Parse province {pro_name}')
    ...
    def __parse_specialities_page(self, response, **kwargs):
        ...
        for option in specialities_options:
            ...
            print(f'Parse specialities for province {pro_name}, speciality {spe_name}')
    ...
    def __parse_services_page(self, response, **kwargs):
        ...
        for option in specialities_options:
            ...
            print(f'Parse services for province {pro_name}, speciality {ser_name}')
    ...
    def __parse_service(self, response, **kwargs):
        ...
        try:
            ...
            print(f'Exception: Description is empty {response.request.url}. Except: {e}')
            description = ''
        ...
        try:
            health_registration = (
                response.css('#centro-medico div div div > strong::text')
                .get().replace('\n', '').strip()
            )
        except Exception:
            health_registration = ''
