...
from apps.core_records.models import ClinicPointRecord
...
class ClinicointScrape(BaseScrape):
    ...
    def __parse_speciality_list(self, response, **kwargs):
        ...
        for speciality in specialities_list:
            ...
            print(f'Parse City {city_name} speciality {speciality_name}')
    ...
    def __parse_speciality_services(self, response, **kwargs):
        ...
        :return:
        """
        print(f'Parse speciality start {response.request.url}')
    ...
    def __parse_sub_speciality_services(self, response, **kwargs):
        ...
        :return:
        """
        print(f'Parse sub speciality start {response.request.url}')
    ...
    def __parse_services(self, response, **kwargs):
        ...
        4. List centers (https://www.clinicpoint.com/madrid/fisioterapia/fisioterapia/1-sesion-de-fisioterapia-y-osteopatia)
        """
        print(f'Parse services start {response.request.url}')
    ...
    def __parse_product(self, response, **kwargs):
        ...
        try:
            ...
            speciality = ' - '.join([
                ...
                kwargs.get('speciality_name1', ''),
                kwargs.get('speciality_name2', ''),
            ])
        ...
        pvp_full = (
            response.css('#offerDetail .prices-container .offer-detail--offer-price--pvpmp span::text')
            .get().replace('€', '').strip()
        )
    ...
    def __get_speciality_services_url(self, province, speciality):
        return f'https://www.clinicpoint.com/{province}/{speciality}'

    def __get_speciality_list_url(self, province):
        return f'https://www.clinicpoint.com/{province}'
